...
class DB {
    ...
    private static function connect() {
        if (! static::$connection) {
            $dsn = 'mysql:dbname='.config('database@database').';host='.config('database.host').'';
            $options = [
            ...
            try {
                static::$connection = new PDO($dsn, config('database@username'), config('database@password'), $options);
            }
